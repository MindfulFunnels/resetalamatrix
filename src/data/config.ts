const config = {
  ...
  secureMessage:
    "Tu información está 100% segura y nunca compartiremos tus datos con nadie. Al registrarte a este reto, también recibirás más información sobre nuestra filosofía, programas y ofertas.",
  logo: "/logo.png",
  cover: "/cover.png",
  whatYouWillLearn: {
    title: "¿Qué aprenderás?",
    items: [
      "Aprenderás a cuidar tu cuerpo y tu mente",
      "Aprenderás a mejorar tu calidad de vida",
